...
- Create Angular project with ng: `ng new campeonatosapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`campeonatosapp.client.esproj`).
